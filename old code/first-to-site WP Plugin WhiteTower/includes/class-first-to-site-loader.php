...
class First_To_Site_Loader {
	...
	/**
	 * The array of actions that need to remove from WordPress.
	 *
	 * @since    1.0.0
	 * @access   protected
	 * @var      array    $actions    The actions registered with WordPress to fire when the plugin loads.
	...
	/**
	 * Remove a registered action from WordPress
	 *
	 * @since    1.0.0
	 * @param    string               $hook             The name of the WordPress action that is being registered.
	 * @param    string               $callback         The name of the function definition on the $component.
	...
	public function remove_action( $hook, $callback, $priority = 10 ) {
		$this->remove_actions = $this->add( $this->remove_actions, $hook, '', $callback, $priority, 1 );
	}
	...
	public function remove_filter( $hook, $callback, $priority = 10 ) {
		$this->remove_filters = $this->add( $this->remove_filters, $hook, '', $callback, $priority, 1 );
	}
